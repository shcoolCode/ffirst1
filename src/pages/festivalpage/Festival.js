...
const rows = [
  createData("가을 체육대회", "김일번", "2020-10-5", [
    { date: "2020-01-05", lname: "황혁주", grade: "3학년1반" },
  ]), //이건왜 안될까.

  createData("경주 현장실습", "이이번", "2020-05-05"),
  createData("서울랜드 현장실습", "박삼번", "2020-06-09"),
  createData("학술제", "유사번", "2020-09-06"),
  createData("전주 한옥마을 현장실습", "서오번", "2020-11-18"),
];
  ...
  return (
    <div className="content">
      <header className="header_frame">
        <text className="header_frame_title">축제/행사</text>
      </header>
