...
const rows = [
  createData("3학년 4반", "김일번", "2020-10-5", [
    { date: "2020-01-05", lname: "황혁주", grade: "3학년1반" },
  ]), //이건왜 안될까.

  createData("2학년 6반", "이이번", "2020-05-05"),
  createData("1학년 10반", "박삼번", "2020-06-09"),
  createData("2학년 9반", "유사번", "2020-09-06"),
  createData("1학년 7반", "서오번", "2020-11-18"),
];
...
function createData(listname, creator, date) {
  return {
    ...
    date,
    history: [
      { date: "2020-01-05", lname: "황혁주", grade: "3학년1반", absent: 0 },
      { date: "2020-01-05", lname: "황혁주", grade: "3학년1반", absent: 0 },
      { date: "2020-01-05", lname: "황혁주", grade: "3학년1반", absent: 0 },
      { date: "2020-01-05", lname: "황혁주", grade: "3학년1반", absent: 0 },
      { date: "2020-01-05", lname: "황혁주", grade: "3학년1반", absent: 0 },
                ...
                <TableBody>
                  {row.history.map((historyRow) => (
                    <TableRow key={historyRow.date}>
                      ...
                      <TableCell>{historyRow.absent}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
  ...
  return (
    <div className="content">
      <header className="header_frame">
        <text className="header_frame_title">교실(등하교) 관리</text>
      </header>
